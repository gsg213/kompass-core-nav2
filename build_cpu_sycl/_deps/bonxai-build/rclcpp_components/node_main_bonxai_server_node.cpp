...
#define NODE_MAIN_LOGGER_NAME "bonxai_server_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbonxai_server.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<bonxai_server::BonxaiServer>";
